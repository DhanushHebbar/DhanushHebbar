  ...
  <table align="center" border="0" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td align="center" width="43%" valign="top">
        ...
        <img src="https://github-profile-summary-cards.vercel.app/api/cards/productive-time?username=DhanushHebbar&theme=tokyonight&utcOffset=5.5" width="100%" />
    ...
    <tr>
      <td width="50%" valign="top">
        ...
        <ul>
          <li>
            <b>MCA (Pursuing)</b><br />
            <i>Shree Devi Institute of Technology (2024 - 2026)</i><br />
            Specializing in AI-Driven Software Architectures.
          </li>
          <li>
            <b>BCA (80.39%)</b><br />
            <i>Padua College of Commerce (2021 - 2024)</i><br />
      ...
      <td width="50%" valign="top">
        ...
        <ul>
          <li>
            ...
            <i>Zephyr Technologies (Mar 2024 - Apr 2024)</i><br />
            • Engineered robust web solutions optimizing API response.<br />
            • Refactored legacy codebases for 20% better efficiency.<br />
